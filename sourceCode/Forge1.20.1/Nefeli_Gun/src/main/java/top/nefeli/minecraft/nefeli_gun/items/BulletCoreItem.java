...
public class BulletCoreItem extends Item {
    ...
    public static ItemStack createStack(float caliber, String material) {
        ItemStack stack = new ItemStack(ModItems.BULLET_CORE.get());
    ...
    public Component getName(ItemStack stack) {
        ...
        return Component.translatable("item.nefeli_gun.bulletcore", caliber.toUpperCase(), material);
    }
}
